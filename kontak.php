      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link px-md-4 active" aria-current="page" href="kontak.php">Contact Us</a>
            </li>
            <li class="nav-item">
        ...
        <div class="mx-auto d-flex flex-lg-row flex-column hero">
          ...
          <div class="left-column flex-lg-grow-1 d-flex flex-column align-items-lg-start text-lg-start align-items-center text-center">
            <h1 class="title-text-big">
              Contact
              <span style="color: #4E91F9">Us</span><br class="d-lg-block d-none" />
            ...
            <p class="text-caption">
              ...
              <br class="d-sm-block d-none" />
              <br class="d-sm-block d-none" />
              087890145279 (Admin 1)
              <br class="d-sm-block d-none" />
              085275790028 (Admin 2)
            </p>
